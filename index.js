const contentLetterSrart_actived = "MỪNG SINH NHẬT 1102 🎂" //Lời mở đầu cho bức thư
const mainContentLetter = "Xinchao -1102- Hôm nay là sn 2 e không tặng quà trực tiếp nên e sẽ tặng 2 món quà tinh thần dù k chính tay làm ra nhưng phải cất công đi mượn làm dùm. Chúc 2 tuổi mới luôn xinh tươi sớm có bồ và bớt stress lại. Mong 2 sẽ vui vẻ với món quà này của e iu 2 iu Rosé nữa❤❤" //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src = "./img/image-PhotoRoom.png";

// Gắn 1 link ảnh bất kì
let imgLetter = document.querySelector(".img");
imgLetter.src = "./img/image-PhotoRoom.png"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
